---
title: 第6章 哈希表
date: 2024-03-25 01:36:31
permalink: /algorithm/hashing/
categories:
  - 技术书籍
  - Hello算法
tags:
...
![哈希表的抽象表示](./assets/hash_table_lookup.png)
...
![哈希函数工作原理](./assets/hash_function.png)
...
![哈希冲突示例](./assets/hash_collision.png)

容易想到，哈希表容量 $n$ 越大，多个 `key` 被分配到同一个桶中的概率就越低，冲突就越少。因此，**我们可以通过扩容哈希表来减少哈希冲突**。

如下图所示，扩容前键值对 `(136, A)` 和 `(236, D)` 发生冲突，扩容后冲突消失。

![哈希表扩容](./assets/hash_table_reshash.png)
...
![链式地址哈希表](./assets/hash_table_chaining.png)
...
![开放寻址（线性探测）哈希表的键值对分布](./assets/hash_table_linear_probing.png)
...
![在开放寻址中删除元素导致的查询问题](./assets/hash_table_open_addressing_deletion.png)
...
![哈希冲突的最佳情况与最差情况](./assets/hash_collision_best_worst_condition.png)
...
<img src="./assets/image-20240325224755861.png" alt="image-20240325224755861" style="zoom:50%;" />
...
<img src="./assets/image-20240325224823081.png" alt="image-20240325224823081" style="zoom:50%;" />
