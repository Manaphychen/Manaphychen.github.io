...
::: center
$T(h) = 2^0h + 2^1(h-1) + 2^2(h-2) + \dots + 2^{h-1}\times1$ <br/>
...
<img src="./assets/image-20240326002315367.png" alt="image-20240326002315367" style="zoom:50%;" />
