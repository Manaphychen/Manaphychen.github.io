...
# 二 创建第三方平台
![image.png](https://cdn.nlark.com/yuque/0/2021/png/2345482/1629882380738-9841d122-f480-49bd-ac5d-b7d30a7a049e.png)<br />授权测试公众号/小程序列表: gh_xxxxxxxxxx<br />其余配置看微信提示
# 三 公众号授权给第三方平台
## 授权事件接收URL
引入微信第三方平台依赖
```xml
