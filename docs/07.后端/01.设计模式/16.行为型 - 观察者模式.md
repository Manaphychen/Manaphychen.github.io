...
author: 
  ...
  link: manaphy.cc
---
## ![image.png](https://cdn.nlark.com/yuque/0/2021/png/2345482/1611816220359-dcfe54a5-11d5-4c8e-8137-28ced48c6b3d.png#averageHue=%23dadcd7&height=400&id=magg5&originHeight=400&originWidth=640&originalType=binary&ratio=1&rotation=0&showTitle=false&size=93899&status=done&style=stroke&title=&width=640)
## 买家支付完成后的N个通知
...
![](https://cdn.nlark.com/yuque/0/2021/png/2345482/1611816139994-3135eb96-8295-4700-8cef-cb66d51d0dcf.png#averageHue=%23f5f4e6&height=478&id=kSYEa&originHeight=638&originWidth=715&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=stroke&title=&width=536)
先编写三个支付系统需要依赖的类：
```java
public class Order {
...
![](https://cdn.nlark.com/yuque/0/2021/png/2345482/1611816236681-737ae4bd-a63d-4b6f-8b19-3f8434e11dd9.png#averageHue=%23f4f4e6&height=361&id=VnnNv&originHeight=481&originWidth=949&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=stroke&title=&width=712)
抽象出观察者接口Observer
```java
...
![](https://cdn.nlark.com/yuque/0/2021/png/2345482/1611816309610-f43d6faa-8c70-479a-9a9d-e0de59112c41.png#averageHue=%23f3f3e3&height=430&id=ENm2u&originHeight=430&originWidth=633&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=stroke&title=&width=633)
**观察者模式通用类图**
