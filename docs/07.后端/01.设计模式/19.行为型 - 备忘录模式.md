...
author: 
  ...
  link: manaphy.cc
---
![image.png](https://cdn.nlark.com/yuque/0/2021/png/2345482/1611816685903-f31b6726-c9cc-4497-b5e5-139ae00de9cf.png#averageHue=%23fafaf9&height=400&id=avVSv&originHeight=400&originWidth=640&originalType=binary&ratio=1&rotation=0&showTitle=false&size=72104&status=done&style=stroke&title=&width=640)
## 程序数据的“后悔药”
...
![](https://cdn.nlark.com/yuque/0/2021/png/2345482/1611816722441-d6fc0061-1477-4a12-b7ce-92ef9408b4e5.png#averageHue=%23f7f7eb&height=640&id=aD36w&originHeight=853&originWidth=878&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=stroke&title=&width=659)
简单吧，这就是备忘录模式！
## 备忘录模式的定义
> 在不破坏封装性的前提下，捕获一个对象的内部状态，并在该对象之外保存这个状态。这样以后就可将该对象恢复到原先保存的状态。

![](https://cdn.nlark.com/yuque/0/2021/png/2345482/1611816703768-20121ec8-86bb-4398-a694-033c1775603c.png#averageHue=%23f4f3cb&height=140&id=UtoOB&originHeight=187&originWidth=996&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=stroke&title=&width=747)
**备忘录模式通用类图**
