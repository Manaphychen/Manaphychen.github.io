...
author: 
  ...
  link: manaphy.cc
---
## ![image.png](https://cdn.nlark.com/yuque/0/2021/png/2345482/1611813808428-9872b80b-29a4-4cc9-b671-ff2fb26f5777.png#averageHue=%23d9dbd6&height=400&id=UXcRX&originHeight=400&originWidth=640&originalType=binary&ratio=1&rotation=0&showTitle=false&size=97035&status=done&style=stroke&title=&width=640)
## 状态决定行为
...
![](https://cdn.nlark.com/yuque/0/2021/png/2345482/1611813730440-453bcab2-d72c-4eb8-8e17-fcd8da6f25fd.png#averageHue=%23f1efc8&height=199&id=Vnip4&originHeight=265&originWidth=825&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=stroke&title=&width=619)
先定义订单状态枚举`StateEnum`：
```java
...
优化后的类图设计如下：
![](https://cdn.nlark.com/yuque/0/2021/png/2345482/1611813833367-988d321b-d6bb-43ec-8d66-d1412e22b750.png#averageHue=%23f4f4e5&height=400&id=zEsBX&originHeight=534&originWidth=1335&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=stroke&title=&width=1001)
...
![](https://cdn.nlark.com/yuque/0/2021/png/2345482/1611814122334-ea246f6f-be53-489b-b6cd-e6118c1f281c.png#averageHue=%23f6f6ec&height=285&id=R1tAY&originHeight=380&originWidth=533&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=stroke&title=&width=400)
**状态模式通用类图**
