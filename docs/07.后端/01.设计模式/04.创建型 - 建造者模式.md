...
author: 
  ...
  link: manaphy.cc
---
![image.png](https://cdn.nlark.com/yuque/0/2021/png/2345482/1611799615226-d6aede48-d3a7-40c0-84fb-761ffd895e29.png#averageHue=%23d6d8d4&height=300&id=dW8wW&originHeight=400&originWidth=640&originalType=binary&ratio=1&rotation=0&showTitle=false&size=63330&status=done&style=stroke&title=&width=480)
## 万能的乐高
...
![](https://cdn.nlark.com/yuque/0/2021/png/2345482/1611799656249-b5b283b0-fa6f-485d-a642-36d32379b306.png#averageHue=%23f5f4e9&height=329&id=oV2eQ&originHeight=438&originWidth=721&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=stroke&title=&width=541)
```java
/**
 * 零件抽象基类
 */
...
```
定义乐高套件，它由四种零件组成：
![](https://cdn.nlark.com/yuque/0/2021/png/2345482/1611799851139-7011a0ac-2190-4b53-9518-e879c6bc3b2a.png#averageHue=%23f5f5e8&height=362&id=SjzQS&originHeight=482&originWidth=718&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=stroke&title=&width=539)
```java
@Getter
@NoArgsConstructor
public class Lego {
...
![](https://cdn.nlark.com/yuque/0/2021/png/2345482/1611800128353-b0eff8b1-4337-4da7-bc74-428abeefd2f4.png#averageHue=%23f3f2e6&height=387&id=ZJKoD&originHeight=516&originWidth=577&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=stroke&title=&width=433)
```java
// 乐高套装构建器
...
![](https://cdn.nlark.com/yuque/0/2021/png/2345482/1611800339815-5e139072-0056-4df1-84fd-58d462a1560d.png#averageHue=%23f4f3e4&height=303&id=cpzMq&originHeight=404&originWidth=622&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=stroke&title=&width=467)
```java
...
![](https://cdn.nlark.com/yuque/0/2021/png/2345482/1611800660552-42c26dac-0763-4db4-91eb-985b655b9f3e.png#averageHue=%23f6f6eb&height=303&id=wezv3&originHeight=404&originWidth=886&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=stroke&title=&width=665)
**建造者模式通用类图**
