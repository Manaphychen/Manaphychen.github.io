...
author: 
  ...
  link: manaphy.cc
---
![image.png](https://cdn.nlark.com/yuque/0/2021/png/2345482/1611737475666-3a86aea4-d5e3-404b-a19a-9af44ed898af.png#averageHue=%23f5f5f4&height=400&id=Q892o&originHeight=400&originWidth=640&originalType=binary&ratio=1&rotation=0&showTitle=false&size=111394&status=done&style=stroke&title=&width=640)
## MySql代理
后端开发人员避免不了要和数据库打交道，MySQL就是时下非常流行的关系型数据库。
假设现有一个SQL语句执行器，它支持两种操作：查询和写入。
![](https://cdn.nlark.com/yuque/0/2021/png/2345482/1611737608454-51e12dc9-d1be-4ada-8329-66e73fbc082c.png#averageHue=%23f2f2e0&height=404&id=Owwti&originHeight=404&originWidth=615&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=stroke&title=&width=615)
```java
...
![](https://cdn.nlark.com/yuque/0/2021/png/2345482/1611737655622-d29aa54b-e5e4-4a09-a153-7ba2fdf6f1fe.png#averageHue=%23f5f4e5&height=420&id=g6zgD&originHeight=560&originWidth=710&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=stroke&title=&width=533)
```java
...
![](https://cdn.nlark.com/yuque/0/2021/png/2345482/1611737719516-9d19c878-17ba-4959-80f4-034a65dca75a.png#averageHue=%23f4f4e6&height=420&id=TDsNB&originHeight=560&originWidth=778&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=stroke&title=&width=584)
```java
...
![](https://cdn.nlark.com/yuque/0/2021/png/2345482/1611737902256-237811b5-8087-47e5-8bcc-978c5e62824e.png#averageHue=%23f5f4e7&height=401&id=t84M2&originHeight=534&originWidth=532&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=stroke&title=&width=399)
**代理模式通用类图**
