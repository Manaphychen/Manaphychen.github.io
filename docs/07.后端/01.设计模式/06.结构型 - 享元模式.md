...
author: 
  ...
  link: manaphy.cc
---
![](https://cdn.nlark.com/yuque/0/2021/png/2345482/1611829397316-a823cc0b-87de-4474-b204-ed4829d7a786.png#averageHue=%23fefefd&height=397&id=XYZEe&originHeight=794&originWidth=1190&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=stroke&title=&width=595)
## 内存溢出，谁的锅？
...
![](https://cdn.nlark.com/yuque/0/2021/png/2345482/1611829450925-4edd726d-0624-4e3a-a15b-4052d573fc2d.png#averageHue=%23f6f6ea&height=400&id=OtIAU&originHeight=533&originWidth=1198&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=stroke&title=&width=899)
描述权限的`Auth`类：
```java
public class Auth {
...
优化后的类图设计如下：
![](https://cdn.nlark.com/yuque/0/2021/png/2345482/1611829493858-d3bd472d-7655-4167-b57b-5de5639bd679.png#averageHue=%23f5f5e7&height=267&id=N5dZU&originHeight=533&originWidth=1605&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=stroke&title=&width=803)
...
![](https://cdn.nlark.com/yuque/0/2021/png/2345482/1611829517785-a032a484-6a61-4bbe-b287-4e15a2163889.png#averageHue=%232f343c&height=620&id=DWhdg&originHeight=620&originWidth=2028&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=stroke&title=&width=2028)
![](https://cdn.nlark.com/yuque/0/2021/png/2345482/1611829529830-32b427d2-87b2-486c-a3ed-4f91badf1ce2.png#averageHue=%232d323b&height=734&id=yDVQQ&originHeight=734&originWidth=1958&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=stroke&title=&width=1958)
如图所示，效果非常明显，这就是享元模式！
## 享元模式的定义
> 使用共享对象可有效地支持大量的细粒度的对象。

![](https://cdn.nlark.com/yuque/0/2021/png/2345482/1611829566426-439e42f4-7596-4e22-b25c-6e37042ac379.png#averageHue=%23f9f8f1&height=445&id=eT6L1&originHeight=594&originWidth=979&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=stroke&title=&width=734)
**享元模式通用类图**
