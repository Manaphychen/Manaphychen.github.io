...
author: 
  ...
  link: manaphy.cc
---
![image.png](https://www.pnglog.com/8PeDjc.png)
## MySql代理
后端开发人员避免不了要和数据库打交道，MySQL就是时下非常流行的关系型数据库。

假设现有一个SQL语句执行器，它支持两种操作：查询和写入。

![](https://www.pnglog.com/aTVzvM.png)
...
<img src="https://www.pnglog.com/KIx4SG.png" style="zoom:67%;" />
...
<img src="https://www.pnglog.com/qFppHf.png" style="zoom:67%;" />
...
<img src="https://www.pnglog.com/QjaG2D.png" style="zoom:80%;" />
