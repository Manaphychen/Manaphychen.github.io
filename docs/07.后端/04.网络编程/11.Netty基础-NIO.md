...
```
![image.png](https://cdn-us.imgs.moe/2024/03/10/1632036693312-4301c19b-40a4-47e5-809f-511092d4300f_gPj6xprtGF.png)
## 2.5 Java BIO 问题分析
...
## 3.3 NIO 三大核心原理
![NIO 三大核心原理示意图](https://cdn-us.imgs.moe/2024/03/10/1632039269883-d26d2bbe-63e6-4133-ab11-c187a95e9dfd_u0f4gVF9y6.png)
...
![缓冲区介绍](https://cdn-us.imgs.moe/2024/03/10/1632042573657-e00c4868-2f42-497d-accf-9c7bb9f5aee4_oPu8uOf5Dz.png)
### 3.4.2 Buffer 类及其子类

1. 在 NIO 中，Buffer 是一个顶层父类，它是一个抽象类, 如下图:

![类的层级关系图](https://cdn-us.imgs.moe/2024/03/10/1632043301688-1d9652a9-f48a-43b4-9cfd-e6bf8911916c_KRYOuRABjj.png)
...
![一开始](https://cdn-us.imgs.moe/2024/03/10/1633962286186-85f21dce-6fa2-4dcb-830d-e896811965a1_KaRWrCA165.png)
### 3.4.5 黏包与半包
...
![image.png](https://cdn-us.imgs.moe/2024/03/10/1632067703545-0a5b2a08-1cc7-4314-9da1-79483b22938a_5w5jso2hi6.png)
```java
@Test
...
### 3.6.2 Selector特点说明
![Selector示意图](https://cdn-us.imgs.moe/2024/03/10/1632140385063-39a31be7-86d1-46a3-8a30-3d453a931580_RZjcL4kNe2.png)
...
## 3.7 NIO 非阻塞网络编程原理分析
![image.png](https://cdn-us.imgs.moe/2024/03/10/1632140678322-6d40886a-84fb-43f5-9dbd-242d07c3984e_i6NHYNUr6V.png)
...
```
![DMA: direct memory access直接内存拷贝(不使用CPU)](https://cdn-us.imgs.moe/2024/03/10/1632405190566-ef58ac40-8f5a-47f7-8fa8-6d8aac0dcbcc_bE5eijM63J.png)
### 3.13.3 mmap 优化
mmap 通过内存映射，将文件映射到内核缓冲区，同时，用户空间可以共享内核空间的数据。这样，在进行网络传输时，就可以减少内核空间到用户控件的拷贝次数。如下图
![image.png](https://cdn-us.imgs.moe/2024/03/10/1632405242689-ea3766e7-1b8a-44bf-9dda-0c45843d7b8c_vfsuCML7cA.png)

3.13.4 sendFile 优化
Linux 2.1 版本 提供了 sendFile 函数，其基本原理如下：数据根本不经过用户态，直接从内核缓冲区进入到 Socket Buffer，同时，由于和用户态完全无关，就减少了一次上下文切换

![image.png](https://cdn-us.imgs.moe/2024/03/10/1632405294788-9e0ab13b-e431-4126-a67b-9a7cd050b53b_4Ng7N4uyt1.png)
