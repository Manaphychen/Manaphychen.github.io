...
## 网络通信协议
TCP/IP协议：又叫网络通信协议，这个协议是 Internet 最基本的协议、Internet 国际互联网的基础，简单地说，就是有网络层的IP协议和传输层的TCP协议组成的。<br />![image.png](https://cdn.nlark.com/yuque/0/2021/png/2345482/1618676092985-ee191599-55a3-4c3a-bb8f-e60492fa3c38.png)
## TCP和UDP
TCP协议：传输控制协议
