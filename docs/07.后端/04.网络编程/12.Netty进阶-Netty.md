...
## 4.2 Netty官网说明
官网：[https://netty.io/](https://netty.io/) <br />![image.png](https://cdn.nlark.com/yuque/0/2021/png/2345482/1632407372852-3cad2ca0-f9f9-4fc2-86fe-cf7e5e0b1ce9.png#averageHue=%23ebe7c1&clientId=ud62ca692-bcbf-4&from=paste&height=720&id=uc30f79f4&originHeight=1440&originWidth=2436&originalType=binary&ratio=1&rotation=0&showTitle=false&size=927747&status=done&style=stroke&taskId=u931096e4-a043-4772-9694-9e8b5a04f9e&title=&width=1218)
...
## 5.2 传统阻塞 I/O 服务模型
### 5.2.1 工作原理图
![工作原理图](https://cdn.nlark.com/yuque/0/2021/png/2345482/1632924719859-ea9f1f97-8293-4055-abdd-51293cc52bda.png#averageHue=%23565c68&clientId=u0b9bdf0f-3357-4&from=paste&height=337&id=u72e7b3f3&originHeight=673&originWidth=732&originalType=binary&ratio=1&rotation=0&showTitle=true&size=256731&status=done&style=none&taskId=u53978890-3dba-4912-b97a-0d20dd8a6d4&title=%E5%B7%A5%E4%BD%9C%E5%8E%9F%E7%90%86%E5%9B%BE&width=366 "工作原理图")
### 5.2.2 模型特点
...
![image.png](https://cdn.nlark.com/yuque/0/2021/png/2345482/1632923180151-8aacb3e5-9597-4094-9663-c36a0b31bedb.png#averageHue=%23eafac8&clientId=u0b9bdf0f-3357-4&from=paste&height=167&id=u5e47a10a&originHeight=334&originWidth=984&originalType=binary&ratio=1&rotation=0&showTitle=false&size=60861&status=done&style=stroke&taskId=u5fd476cd-7fe8-4319-89d6-252c907cbc5&title=&width=492)
### 5.3.2 I/O 复用结合线程池，就是 Reactor 模式基本设计思想
![image.png](https://cdn.nlark.com/yuque/0/2021/png/2345482/1632924738517-2e4e9bff-0dc6-4929-b98d-d5008228f7f0.png#averageHue=%23555a66&clientId=u0b9bdf0f-3357-4&from=paste&height=362&id=u05cdb42f&originHeight=483&originWidth=732&originalType=binary&ratio=1&rotation=0&showTitle=false&size=208598&status=done&style=none&taskId=ud14fe357-4a9b-4b66-a145-2d2dadcb1de&title=&width=549)
...
**Reactor**：Reactor 在一个单独的线程中运行，负责监听和分发事件，分发给适当的处理程序来对 IO 事件做出反应。 它就像公司的电话接线员，它接听来自客户的电话并将线路转移到适当的联系人<br />**Handlers**：处理程序执行 I/O 事件要完成的实际事件，类似于客户想要与之交谈的公司中的实际官员。Reactor 通过调度适当的处理程序来响应 I/O 事件，处理程序执行非阻塞操作。
### 5.3.4 Reactor 模式分类
...
## 5.4 单 Reactor 单线程
### 5.4.1 工作原理示意图
![工作原理示意图](https://cdn.nlark.com/yuque/0/2021/png/2345482/1632925556056-b94256a0-40ae-41c5-bf4d-7eb4d093fd13.png#averageHue=%23555a66&clientId=u0b9bdf0f-3357-4&from=paste&height=362&id=uc1899866&originHeight=483&originWidth=732&originalType=binary&ratio=1&rotation=0&showTitle=true&size=208598&status=done&style=none&taskId=u1d6872d1-e71c-4353-90ec-d7f83e67fa5&title=%E5%B7%A5%E4%BD%9C%E5%8E%9F%E7%90%86%E7%A4%BA%E6%84%8F%E5%9B%BE&width=549 "工作原理示意图")<br />前面的 NIO 群聊系统就是这种模型
### 5.4.2 方案说明
...
## 5.5 单Reactor多线程
### 5.5.1 工作原理示意图
![工作原理示意图](https://cdn.nlark.com/yuque/0/2021/png/2345482/1632925533679-891c3435-4fb5-4db0-b2d1-fda16b7db2c8.png#averageHue=%23575c68&clientId=u0b9bdf0f-3357-4&from=paste&height=528&id=u22fd783c&originHeight=704&originWidth=732&originalType=binary&ratio=1&rotation=0&showTitle=true&size=336113&status=done&style=none&taskId=u9080a846-a2eb-4617-888d-03b312ba786&title=%E5%B7%A5%E4%BD%9C%E5%8E%9F%E7%90%86%E7%A4%BA%E6%84%8F%E5%9B%BE&width=549 "工作原理示意图")
### 5.5.2 方案说明
...
## 5.6 主从 Reactor 多线程
### 5.6.1 工作原理示意图
针对单 Reactor 多线程模型中，Reactor 在单线程中运行，高并发场景下容易成为性能瓶颈，可以让 Reactor 在多线程中运行<br />![工作原理示意图](https://cdn.nlark.com/yuque/0/2021/png/2345482/1632925752544-95c79e94-77c0-4375-9ec1-1ef43cad1bdb.png#averageHue=%23565b67&clientId=u0b9bdf0f-3357-4&from=paste&height=550&id=u287c869d&originHeight=732&originWidth=706&originalType=binary&ratio=1&rotation=0&showTitle=true&size=347966&status=done&style=none&taskId=u1694f09c-3f3b-44de-a93d-0ac40a5ab86&title=%E5%B7%A5%E4%BD%9C%E5%8E%9F%E7%90%86%E7%A4%BA%E6%84%8F%E5%9B%BE&width=530 "工作原理示意图")
### 5.6.2 方案说明
...
![image.png](https://cdn.nlark.com/yuque/0/2021/png/2345482/1632925979088-b8f63049-a987-436b-8f0b-f02753c1cbdb.png#averageHue=%23f2f2e0&clientId=u0b9bdf0f-3357-4&from=paste&height=360&id=u1b0d87a9&originHeight=1440&originWidth=2126&originalType=binary&ratio=1&rotation=0&showTitle=false&size=2621087&status=done&style=stroke&taskId=u45376515-8b17-4982-9470-9f5b001fba3&title=&width=532)
### 5.6.4 方案优缺点说明
...
## 5.8 Netty模型
### 5.8.1 工作原理-简单版
Netty 主要基于主从 Reactors 多线程模型（如图）做了一定的改进，其中主从 Reactor 多线程模型有多个 Reactor<br />![工作原理示意图1-简单版](https://cdn.nlark.com/yuque/0/2021/png/2345482/1632926183535-a216a060-8582-4578-8038-0f20f69382b3.png#averageHue=%2397ac5c&clientId=u0b9bdf0f-3357-4&from=paste&height=216&id=ua70de299&originHeight=432&originWidth=1440&originalType=binary&ratio=1&rotation=0&showTitle=true&size=89648&status=done&style=stroke&taskId=u7c05a663-38ca-4768-aeb0-8b5af203d43&title=%E5%B7%A5%E4%BD%9C%E5%8E%9F%E7%90%86%E7%A4%BA%E6%84%8F%E5%9B%BE1-%E7%AE%80%E5%8D%95%E7%89%88&width=720 "工作原理示意图1-简单版")<br />**说明**
...
### 5.8.2 工作原理-进阶版
Netty 主要基于主从 Reactors 多线程模型（如图）做了一定的改进，其中主从 Reactor 多线程模型有多个 Reactor<br />![工作原理示意图2-进阶版](https://cdn.nlark.com/yuque/0/2021/png/2345482/1632926382563-0eeb1694-642e-41b8-953c-70842180dd1c.png#averageHue=%23e2e4cc&clientId=u0b9bdf0f-3357-4&from=paste&height=295&id=uc5011c7f&originHeight=589&originWidth=1049&originalType=binary&ratio=1&rotation=0&showTitle=true&size=634553&status=done&style=stroke&taskId=u38df4ae4-28b5-4df9-9113-e20c2862a14&title=%E5%B7%A5%E4%BD%9C%E5%8E%9F%E7%90%86%E7%A4%BA%E6%84%8F%E5%9B%BE2-%E8%BF%9B%E9%98%B6%E7%89%88&width=524.5 "工作原理示意图2-进阶版")
### 5.8.3 工作原理-详细版
![工作原理示意图-详细版](https://cdn.nlark.com/yuque/0/2021/png/2345482/1632926626845-88665fec-2b5c-4653-9411-45552e3d2a4d.png#averageHue=%23535864&clientId=u0b9bdf0f-3357-4&from=paste&height=695&id=u47d2dcce&originHeight=1390&originWidth=1658&originalType=binary&ratio=1&rotation=0&showTitle=true&size=1066005&status=done&style=stroke&taskId=u2df80dbf-df96-4be0-9c8b-9bb6c8eceb5&title=%E5%B7%A5%E4%BD%9C%E5%8E%9F%E7%90%86%E7%A4%BA%E6%84%8F%E5%9B%BE-%E8%AF%A6%E7%BB%86%E7%89%88&width=829 "工作原理示意图-详细版")
...
### 5.9.3 工作原理
![工作原理示意图](https://cdn.nlark.com/yuque/0/2021/png/2345482/1633082479753-f077bd2b-82ca-43d9-88ee-a4830c4e0431.png#averageHue=%23f0f0ef&clientId=u524ad77e-ca12-4&from=paste&height=212&id=u7bd5444e&originHeight=846&originWidth=2560&originalType=binary&ratio=1&rotation=0&showTitle=true&size=1153946&status=done&style=stroke&taskId=u14a08977-b69c-4709-b1c8-453ddd929d5&title=%E5%B7%A5%E4%BD%9C%E5%8E%9F%E7%90%86%E7%A4%BA%E6%84%8F%E5%9B%BE&width=640 "工作原理示意图")<br />**说明：**
...
Bootstrap 意思是引导，一个 Netty 应用通常由一个 Bootstrap 开始，主要作用是配置整个 Netty 程序，串联各个组件，Netty 中 Bootstrap 类是客户端程序的启动引导类，ServerBootstrap 是服务端启动引导类<br />**常见的方法有**
...
Netty 中所有的 IO 操作都是异步的，不能立刻得知消息是否被正确处理。但是可以过一会等它执行完成或者直接注册一个监听，具体的实现就是通过 Future 和 ChannelFutures，他们可以注册一个监听，当操作执行成功或失败时监听会自动触发注册的监听事件<br />**常见的方法有**
...
ChannelHandler 是一个接口，处理 I/O 事件或拦截 I/O 操作，并将其转发到其 ChannelPipeline(业务处理链)中的下一个处理程序。<br />ChannelHandler 本身并没有提供很多方法，因为这个接口有许多的方法需要实现，方便使用期间，可以继承它的子类<br />**ChannelHandler 及其实现类**<br />![ChannelHandler 及其实现类一览图](https://cdn.nlark.com/yuque/0/2021/png/2345482/1633111341891-fd60c34a-7f48-4ad5-a434-70d305cd76bb.png#averageHue=%23fafaf9&clientId=u524ad77e-ca12-4&from=paste&height=357&id=u35a04933&originHeight=1427&originWidth=2560&originalType=binary&ratio=1&rotation=0&showTitle=true&size=489842&status=done&style=stroke&taskId=u2309efc5-531d-4e57-9c8f-f545acd3f28&title=ChannelHandler%20%E5%8F%8A%E5%85%B6%E5%AE%9E%E7%8E%B0%E7%B1%BB%E4%B8%80%E8%A7%88%E5%9B%BE&width=640 "ChannelHandler 及其实现类一览图")
...
![Channel 和 ChannelPipeline的组成关系](https://cdn.nlark.com/yuque/0/2021/png/2345482/1633111923925-17074c50-c854-4345-8f04-cd0b05b4519c.png#averageHue=%235a5c67&clientId=u524ad77e-ca12-4&from=paste&height=208&id=uc98b095a&originHeight=831&originWidth=2560&originalType=binary&ratio=1&rotation=0&showTitle=true&size=1157186&status=done&style=none&taskId=ue7153327-a4c3-4720-8fc0-0a47b6a51c2&title=Channel%20%E5%92%8C%20ChannelPipeline%E7%9A%84%E7%BB%84%E6%88%90%E5%85%B3%E7%B3%BB&width=640 "Channel 和 ChannelPipeline的组成关系")
...
## 6.8 ChannelOption
Netty 在创建 Channel 实例后,一般都需要设置 ChannelOption 参数。<br />ChannelOption 参数如下:

**ChannelOption.SO_BACKLOG**<br />对应 TCP/IP 协议 listen 函数中的 backlog 参数，用来初始化服务器可连接队列大小。服务端处理客户端连接请求是顺序处理的，所以同一时间只能处理一个客户端连接。多个客户端来的时候，服务端将不能处理的客户端连接请求放在队列中等待处理，backlog 参数指定了队列的大小。

**ChannelOption.SO_KEEPALIVE**<br />一直保持连接活动状态
...
![image.png](https://cdn.nlark.com/yuque/0/2021/png/2345482/1633363822081-1f8785aa-c89f-4a6b-bb28-67b7c5c0aa59.png#averageHue=%23f7f7f7&clientId=u15ffda76-310d-4&from=paste&height=325&id=ud0f7a260&originHeight=724&originWidth=2078&originalType=binary&ratio=1&rotation=0&showTitle=false&size=206951&status=done&style=stroke&taskId=ua5912987-d228-4e6e-9694-b6a1b5ff012&title=&width=932)
...
`public NioEventLoopGroup()`，构造方法<br />`public Future<?> shutdownGracefully()`，断开连接，关闭线程
## 6.10 Unpooled 类
