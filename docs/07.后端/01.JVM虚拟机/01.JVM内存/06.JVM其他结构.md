...
<img src="./assets/image-20240323112633394_zybq6DVG1F.png" alt="image-20240323112633394" style="zoom:50%;" />

### 非直接缓存区

使用IO读写文件，需要与磁盘交互，需要由用户态切换到内核态。在内核态时，需要两份内存存储重复数据，效率低。

<img src="./assets/image-20240323104732025_8tyWzRMtO5.png" alt="image-20240323104732025" style="zoom:50%;" />

### 直接缓存区

使用NIO时，操作系统划出的直接缓存区可以被java代码直接访问，只有一份。NIO适合对大文件的读写操作。

<img src="./assets/image-20240323104841748_MEtkQoAPlb.png" alt="image-20240323104841748" style="zoom:50%;" />
