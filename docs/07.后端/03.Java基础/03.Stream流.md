...
```
**stream 和 parallelStream  的简单区分：** stream是顺序流，由主线程按顺序对流执行操作，而parallelStream是并行流，内部以多线程并行执行的方式对流进行操作，但前提是流中的数据处理没有顺序要求。例如筛选集合中的奇数，两者的处理不同之处：<br />![image.png](https://cdn.nlark.com/yuque/0/2021/png/2345482/1638855398192-05cbf19a-9669-48f8-a646-3d9034390fc0.png#averageHue=%23303030&clientId=udde8e912-889b-4&errorMessage=unknown%20error&from=paste&height=410&id=ua638ad4b&originHeight=546&originWidth=690&originalType=binary&ratio=1&rotation=0&showTitle=false&size=22339&status=error&style=stroke&taskId=u0dd96711-41e7-4e6b-b5ba-8a07d8e872a&title=&width=518)<br />如果流中的数据量足够大，并行流可以加快处速度。<br />除了直接创建并行流，还可以通过`parallel()`把顺序流转换成并行流：
```java
...
![image.png](https://cdn.nlark.com/yuque/0/2021/png/2345482/1638858983423-a0eb172e-904d-4204-854d-bab52e3f779b.png#averageHue=%23f1f1f0&clientId=udde8e912-889b-4&errorMessage=unknown%20error&from=paste&height=150&id=uea8bc7e7&originHeight=202&originWidth=403&originalType=binary&ratio=1&rotation=0&showTitle=false&size=11976&status=error&style=stroke&taskId=ub2898046-145b-47d1-a26c-3ec82710117&title=&width=299)     ![image.png](https://cdn.nlark.com/yuque/0/2021/png/2345482/1638858997843-4afeb2ad-8bba-4f55-b432-66fa50167510.png#averageHue=%23f1eded&clientId=udde8e912-889b-4&errorMessage=unknown%20error&from=paste&height=150&id=u1ab48ce6&originHeight=205&originWidth=403&originalType=binary&ratio=1&rotation=0&showTitle=false&size=21881&status=error&style=stroke&taskId=ucf5b0199-f0d2-4509-b194-0c0c21f9e8d&title=&width=295)
```java
...
![image.png](https://cdn.nlark.com/yuque/0/2021/png/2345482/1638870073531-b14eae08-672f-4daf-9c51-d938ea59330c.png#averageHue=%23ece2d8&clientId=udde8e912-889b-4&errorMessage=unknown%20error&from=paste&height=131&id=ue916340c&originHeight=174&originWidth=721&originalType=url&ratio=1&rotation=0&showTitle=false&size=31497&status=error&style=stroke&taskId=u74a740fe-f647-41dc-a5cf-c0308fef693&title=&width=541)
```java
// 将学生根据性别分组
