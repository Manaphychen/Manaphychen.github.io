---
title: 若需要精确答案就应避免使用 float 和 double 类型
...
---
- **Previous Item（上一条目）：[Item 59: Know and use the libraries（了解并使用库）](./59-Know-and-use-the-libraries.md)**
- **Next Item（下一条目）：[Item 61: Prefer primitive types to boxed primitives（基本数据类型优于包装类）](./61-Prefer-primitive-types-to-boxed-primitives.md)**
