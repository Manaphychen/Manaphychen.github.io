...
```
执行`docker-compose up -d`运行<br />在服务器搭建需要穿透的服务，如<br />![image.png](https://cdn.nlark.com/yuque/0/2021/png/2345482/1624608197111-abddc61c-abb8-4652-8583-a7073bde26f6.png)
## 配置穿透
回到web界面 配置管理<br />![image.png](https://cdn.nlark.com/yuque/0/2021/png/2345482/1624608459902-bec825a7-782d-4088-a4bd-24702d06ec4e.png)
# NPS
