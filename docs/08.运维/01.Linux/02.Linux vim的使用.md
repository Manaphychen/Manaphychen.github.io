...
![image.png](https://cdn.nlark.com/yuque/0/2021/png/2345482/1610678655688-a10d0e29-c410-4144-892f-bf904d7b56b9.png)
# vi 和 vim 的三种常见模式
## 正常模式
...
## 命令行模式
在这个模式当中， 可以提供你相关指令，完成读取、存盘、替换、离开 vim 、显示行号等的动作则是在此模式中达成的！<br />![vi 和 vim 三种模式的相互转化图](https://cdn.nlark.com/yuque/0/2021/png/2345482/1612103416113-8df24c85-795d-4674-ba26-54bedf346eea.png)
# 快捷键的使用案例
