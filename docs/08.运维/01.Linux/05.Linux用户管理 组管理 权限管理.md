...
![image.png](https://cdn.nlark.com/yuque/0/2021/png/2345482/1610705892748-09f1e989-e9ea-464d-bdf0-1b5132cdfbec.png#averageHue=%232d2624&height=153&id=rN26U&originHeight=153&originWidth=481&originalType=binary&ratio=1&rotation=0&showTitle=false&size=16334&status=done&style=none&title=&width=481)<br />上图红框内即为文件的所有者，蓝框即为文件的所在组
```bash
# 增加组
groupadd wudang
# 删除组
...
# 权限管理
## 权限的基本介绍
drwxr-xr-x  4 root root 4096 Jul 14  2020 tomcat<br />0-9位说明<br />第 **0** 位确定文件类型(d, - , l , c , b)
...
第 **1-3** 位确定**所有者**拥有该文件的权限 ---User<br />第 **4-6** 位确定**所属组**拥有该文件的权限 ---Group<br />第 **7-9** 位确定**其他用户**拥有该文件的权限 ---Other
## rwx 权限详解
**rwx 作用到文件**
...
**文件及目录权限实际案例**<br />drwxr-xr-x  4 root root 4096 Jul 14  2020 tomcat
