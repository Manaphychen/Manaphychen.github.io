...
![image.png](https://cdn.nlark.com/yuque/0/2021/png/2345482/1610725653302-0c6d0b84-b18c-4338-b4cb-f83d0784e60b.png#averageHue=%23eee7e0&height=232&id=Ut3sn&originHeight=467&originWidth=1611&originalType=binary&ratio=1&rotation=0&showTitle=false&size=349067&status=done&style=stroke&title=&width=800)
```bash
crontab -e #编辑定时任务
crontab -l #查询定时任务
