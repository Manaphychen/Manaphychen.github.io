...
```
**修改Vmware设置**<br />子网IP<br />![image.png](https://cdn.nlark.com/yuque/0/2021/png/2345482/1610876423251-eca89b75-95f5-47f2-ba74-dc4053b640cc.png)<br />完成以上步骤后即可修改为静态ip
# 设置主机名和hosts 映射
```bash
...
![image.png](https://cdn.nlark.com/yuque/0/2021/png/2345482/1610879873780-e3e2771a-a68b-4ba4-8d46-5fcd392e7b8f.png)
