...
![image.png](https://cdn.nlark.com/yuque/0/2022/png/2345482/1660879728639-9d558ab2-5c09-4bcd-a0ee-e9ce8e9c521a.png)<br />“/dev/sda5”表示的就是“这是系统中第一块被识别到的硬件设备中分区编号为 5 的 逻辑分区的设备文件”。
# 文件系统与数据资料
