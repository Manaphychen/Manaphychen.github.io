...
sudo tee /etc/docker/daemon.json <<-'EOF'
{
  "registry-mirrors": [
      ...
      "https://eekuwuxe.mirror.aliyuncs.com"
  ]
}
EOF
...
redis-cli --cluster create \
  ...
  --cluster-replicas 1
```
<img src="https://www.pnglog.com/5AM4qY.png" alt="image.png" style="zoom:50%;" />	

查看集群状态

<img src="https://www.pnglog.com/b80Tf5.png" alt="image.png" style="zoom:50%;" />

查看节点状态

![image.png](https://www.pnglog.com/nZqJ2m.png)
