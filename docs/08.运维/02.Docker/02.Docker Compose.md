...
curl -L https://get.docker.com/compose/1.29.2/docker-compose-`uname -s`-`uname -m` -o /usr/local/bin/docker-compose
#修改权限
...
<img src="https://cdn.nlark.com/yuque/0/2021/png/2345482/1635909960551-e1ea98a8-233b-4ff3-81ee-6d3ef3d9f3a2.png" alt="image.png" style="zoom:50%;" />
