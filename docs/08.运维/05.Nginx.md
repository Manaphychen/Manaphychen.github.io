...
## **漏桶流算法和令牌桶算法**
**漏桶算法**<br />漏桶算法思路很简单，我们把水比作是请求，漏桶比作是系统处理能力极限，水先进入到漏桶里，漏桶里的水按一定速率流出，当流出的速率小于流入的速率时，由于漏桶容量有限，后续进入的水直接溢出（拒绝请求），以此实现限流。<br />![](https://cdn.nlark.com/yuque/0/2022/png/2345482/1652523175005-e9a0ebf1-033c-4701-b73a-681cfcfe4366.png)
## **Nginx配置高可用性**
