...
```
访问`http://服务器ip:5601/`查看Kibana状况<br />![](https://img-blog.csdnimg.cn/20200703145603788.png)<br />如需修改Kibana为中文,则执行以下命令
```bash
#进入kibana容器
...
```
再次访问`http://服务器ip:5601/`就可以看到界面变中文了<br />![](https://img-blog.csdnimg.cn/20200703150153771.png)<br />至此 ELK基于docker搭建完成
...
![](https://img-blog.csdnimg.cn/20200703153217830.png)

6.查看日志

![](https://img-blog.csdnimg.cn/20200703153831799.png)<br />

7.可以根据各种条件筛选日志

![](https://img-blog.csdnimg.cn/20200703154327941.png)
