...
![image.png](https://www.pnglog.com/g0fD8F.png)
...
```
![image.png](https://www.pnglog.com/h68iAt.png)
...
<img src="https://www.pnglog.com/QI39tR.png" alt="image.png" style="zoom:67%;" />
...
FROM goods;
```
![image.png](https://www.pnglog.com/oPm02Q.png)
...
WHERE row_num <= 3;
```
![image.png](https://cdn.nlark.com/yuque/0/2021/png/2345482/1639015150331-437e7ee3-690b-48ca-952e-e64589631bda.png)
...
FROM goods;
```
![image.png](https://www.pnglog.com/1weWR4.png)
...
```
![image.png](https://www.pnglog.com/7S1059.png)
...
FROM goods;
```
![image.png](https://www.pnglog.com/EYJzGh.png)
...
```
![image.png](https://www.pnglog.com/qTNnrw.png)
...
```
![image.png](https://www.pnglog.com/4yipgy.png)
...
FROM goods;
```
![image.png](https://www.pnglog.com/7R5Dbf.png)
#### 3. 前后函数
**1．LAG(expr,n)函数**
...
```
![image.png](https://www.pnglog.com/8havGN.png)
...
```
![image.png](https://cdn.nlark.com/yuque/0/2021/png/2345482/1639018666662-342756ed-0d9e-42ff-87c0-ec789931e8ed.png)
#### 4. 首尾函数
...
```
![image.png](https://www.pnglog.com/9GBWnd.png)
...
FROM goods WINDOW w AS (PARTITION BY category_id ORDER BY price);
```
![image.png](https://www.pnglog.com/0U6znm.png)
#### 5. 其他函数
...
FROM goods WINDOW w AS (PARTITION BY category_id ORDER BY price);
```
![image.png](https://www.pnglog.com/rLm4Ar.png)
...
FROM goods WINDOW w AS (PARTITION BY category_id ORDER BY price);
```
![image.png](https://www.pnglog.com/YElhou.png)
### 2.5 小 结
