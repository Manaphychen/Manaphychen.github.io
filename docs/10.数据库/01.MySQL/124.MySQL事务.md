...
```
![image.png](https://www.pnglog.com/GQG7t4.png)
...
![image.png](https://cdn.nlark.com/yuque/0/2022/png/2345482/1652020965162-ec40b41a-dcee-4e6a-8053-1f16be3717c1.png)
...
![image.png](https://www.pnglog.com/FTsAmL.png)

**2. 脏读（Dirty Read ）**

对于两个事务 Session A、Session B，Session A `读取`了已经被 Session B `更新`但还`没有被提交`的字段。之后若 Session B `回滚`，Session A `读取`的内容就是`临时且无效`的。

![image.png](https://www.pnglog.com/nFjsvh.png)
...
![image.png](https://www.pnglog.com/8Yi70k.png)
...
![image.png](https://cdn.nlark.com/yuque/0/2022/png/2345482/1652106897915-fb0ddac3-906e-4a0b-8e4c-8fe75d1d181f.png)
...
![image.png](https://www.pnglog.com/jjn5Ee.png)

`脏写`怎么没涉及到？因为脏写这个问题太严重了，不论是哪种隔离级别，都不允许脏写的情况发生。

不同的隔离级别有不同的现象，并有不同的锁和并发机制，隔离级别越高，数据库的并发性能就越差，4种事务隔离级别与并发性能的关系如下：

![image.png](https://www.pnglog.com/jdWdE2.png)
## 3.4 MySQL支持的四种隔离级别
...
![image.png](https://www.pnglog.com/Idsmp4.png)

事务1和事务2的执行流程如下：

![image.png](https://www.pnglog.com/ctV6tw.png)

**演示2：读已提交**

![image.png](https://www.pnglog.com/Gb50fo.png)

设置隔离级别为可重复读，事务的执行流程如下：

![image.png](https://www.pnglog.com/QyAQst.png)

![image.png](https://www.pnglog.com/xzl3GZ.png)
# 4. 事务的常见分类
...
![image.png](https://www.pnglog.com/nhZtZj.png)
