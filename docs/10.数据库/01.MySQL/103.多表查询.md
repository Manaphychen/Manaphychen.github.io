...
![image.png](https://www.pnglog.com/t0UOaY.png)
...
![image.png](https://www.pnglog.com/O3GwIv.png)

UNION 操作符返回两个查询的结果集的并集，去除重复记录。

**UNION ALL操作符**

![image.png](https://www.pnglog.com/blajOp.png)
...
```
## 5. 7种SQL JOINS的实现
![image.png](https://www.pnglog.com/Y9xw3l.png)
### 5.7.1 代码实现
```sql
-- 中图：内连接 A∩B
