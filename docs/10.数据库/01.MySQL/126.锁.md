---
title: 锁
date: 2023-10-25 14:40:09
permalink: /mysql/c7b818/
categories:
  - 数据库
  - MySQL
tags:
...
![image.png](https://cdn.nlark.com/yuque/0/2022/png/2345482/1652363869052-bdaa8918-cf59-4dc9-ad9e-6463c7dc4429.png#averageHue=%23b6d7f2&clientId=u5906d71e-16ef-4&errorMessage=unknown%20error&from=paste&height=65&id=ua6b76af3&originHeight=129&originWidth=507&originalType=binary&ratio=1&rotation=0&showTitle=false&size=9795&status=error&style=stroke&taskId=u50b9a548-6c78-4396-8c22-0946c144e68&title=&width=253.5)
当一个事务想对这条记录做改动时，首先会看看内存中有没有与这条记录关联的`锁结构`，当没有的时候就会在内存中生成一个锁结构与之关联。比如，事务T1 要对这条记录做改动，就需要生成一个锁结构与之关联：
![image.png](https://cdn.nlark.com/yuque/0/2022/png/2345482/1652363910862-2637873c-df3a-4e32-852e-79f0a0e30294.png#averageHue=%23c2ddc3&clientId=u5906d71e-16ef-4&errorMessage=unknown%20error&from=paste&height=204&id=u97bf4fe5&originHeight=407&originWidth=1309&originalType=binary&ratio=1&rotation=0&showTitle=false&size=38444&status=error&style=stroke&taskId=uacf3506b-d3ca-4a19-bbc0-f0598a6f096&title=&width=655)
...
![image.png](https://cdn.nlark.com/yuque/0/2022/png/2345482/1652363923473-f6241d02-f3ca-4b16-804a-37929d6c0588.png#averageHue=%23e2c7a0&clientId=u5906d71e-16ef-4&errorMessage=unknown%20error&from=paste&height=420&id=u5c7632a6&originHeight=560&originWidth=842&originalType=binary&ratio=1&rotation=0&showTitle=false&size=73029&status=error&style=stroke&taskId=u168cc676-82ef-408f-97cc-2de52d7b73c&title=&width=632)
...
![image.png](https://cdn.nlark.com/yuque/0/2022/png/2345482/1652363975301-f5767001-cbbb-4ffc-bd37-03cbf486dbdd.png#averageHue=%23bbd6bc&clientId=u5906d71e-16ef-4&errorMessage=unknown%20error&from=paste&height=178&id=u766297d0&originHeight=237&originWidth=677&originalType=binary&ratio=1&rotation=0&showTitle=false&size=18124&status=error&style=stroke&taskId=ufa635474-f2e5-4888-8e84-1d08d3f7bdf&title=&width=508)
小结几种说法：
...
# 3. 锁的不同角度分类
锁的分类图，如下：
![image.png](https://cdn.nlark.com/yuque/0/2022/png/2345482/1652364529421-bcdf9767-0656-4db8-b060-8554eebe4c7f.png#averageHue=%23fbfbfb&clientId=u5906d71e-16ef-4&errorMessage=unknown%20error&from=paste&height=700&id=u5f174036&originHeight=2220&originWidth=1732&originalType=binary&ratio=1&rotation=0&showTitle=false&size=396787&status=error&style=stroke&taskId=uaa761d95-fca2-4344-95b3-7f7378be71f&title=&width=546)
...
![image-20220328185943202.png](https://cdn.nlark.com/yuque/0/2022/png/2345482/1654135547238-625f891e-3d36-4195-b4f9-b68d4e49e42f.png#averageHue=%23f2efe8&clientId=u2bd2b050-3109-4&errorMessage=unknown%20error&from=paste&height=181&id=u86f0e9d1&originHeight=362&originWidth=1034&originalType=binary&ratio=1&rotation=0&showTitle=false&size=63650&status=error&style=stroke&taskId=ub9ec17b7-ba9e-4f65-8583-3d792399e96&title=&width=517)
举例如下：
![image-20220328185953649.png](https://cdn.nlark.com/yuque/0/2022/png/2345482/1654135570578-397215d3-8b36-4f45-9b89-ced73820935d.png#averageHue=%23f5f5f5&clientId=u2bd2b050-3109-4&errorMessage=unknown%20error&from=paste&height=352&id=ud2a09a63&originHeight=469&originWidth=920&originalType=binary&ratio=1&rotation=0&showTitle=false&size=35778&status=error&style=stroke&taskId=u85335118-37eb-43fc-8534-6273cc36002&title=&width=690)
...
![image-20220328190138150.png](https://cdn.nlark.com/yuque/0/2022/png/2345482/1654135613198-f38b9038-e779-472b-b2d8-a1e9cbc8447f.png#averageHue=%23edd1a8&clientId=u2bd2b050-3109-4&errorMessage=unknown%20error&from=paste&height=178&id=ucd492db0&originHeight=356&originWidth=849&originalType=binary&ratio=1&rotation=0&showTitle=false&size=82652&status=error&style=stroke&taskId=u42b36ab1-fcae-4926-b3ff-6dbee396155&title=&width=424.5)
...
| --- | --- | --- |
| 1 | start transaction;  
update account set money=10 where id=1; | start transaction; |
...
# 4. 锁的内存结构
InnoDB存储引擎中的锁结构如下：
![image-20220328191907367.png](https://cdn.nlark.com/yuque/0/2022/png/2345482/1654135836436-1e54c94d-902a-40f3-82c2-916969d87f56.png#averageHue=%23f5d8ac&clientId=u2bd2b050-3109-4&errorMessage=unknown%20error&from=paste&height=430&id=u5c08ee76&originHeight=860&originWidth=1211&originalType=binary&ratio=1&rotation=0&showTitle=false&size=111586&status=error&style=stroke&taskId=u5ba7fc08-c32a-4e1e-8183-c0b2e4b9b8c&title=&width=605.5)
结构解析：
...
![image-20220328192308086.png](https://cdn.nlark.com/yuque/0/2022/png/2345482/1654135885597-da805ccf-1867-4cf5-a56e-d3059c29b109.png#averageHue=%23f4efe8&clientId=u2bd2b050-3109-4&errorMessage=unknown%20error&from=paste&height=222&id=u9b8e9549&originHeight=443&originWidth=1450&originalType=binary&ratio=1&rotation=0&showTitle=false&size=140926&status=error&style=stroke&taskId=u05386643-f7e4-4831-b052-c33ef5a3600&title=&width=725)
...
6.  一堆比特位：
如果是`行锁结构`的话，在该结构末尾还放置了一堆比特位，比特位的数量是由上边提到的n_bits属性表示的。InnoDB数据页中的每条记录在记录头信息中都包含一个heap_no属性，伪记录Infimum的heap_no值为 0 ，Supremum的heap_no值为 1 ，之后每插入一条记录，heap_no值就增 1 。锁结构最后的一堆比特位就对应着一个页面中的记录，一个比特位映射一个heap_no，即一个比特位映射到页内的一条记录。 
# 5. 锁监控
...
![image-20220328194408224.png](https://cdn.nlark.com/yuque/0/2022/png/2345482/1654136157313-d45ff268-493b-4117-b145-18d9c5e6f48b.png#averageHue=%23efefef&clientId=u2bd2b050-3109-4&errorMessage=unknown%20error&from=paste&height=237&id=ucda17a65&originHeight=474&originWidth=1904&originalType=binary&ratio=1&rotation=0&showTitle=false&size=30956&status=error&style=stroke&taskId=u9d22a50c-9ba4-4d46-a207-13883185a0c&title=&width=952)
...
![image-20220328194408224.png](https://cdn.nlark.com/yuque/0/2022/png/2345482/1654136157313-d45ff268-493b-4117-b145-18d9c5e6f48b.png#averageHue=%23efefef&clientId=u2bd2b050-3109-4&errorMessage=unknown%20error&from=paste&height=237&id=DvhGz&originHeight=474&originWidth=1904&originalType=binary&ratio=1&rotation=0&showTitle=false&size=30956&status=error&style=stroke&taskId=u9d22a50c-9ba4-4d46-a207-13883185a0c&title=&width=952)
...
```
下图为这个表的索引id的示意图。
![image-20220328194721419.png](https://cdn.nlark.com/yuque/0/2022/png/2345482/1654136185658-43a4a85d-26b1-4372-ab3b-7a8b6f135251.png#averageHue=%23c6e1c7&clientId=u2bd2b050-3109-4&errorMessage=unknown%20error&from=paste&height=86&id=BVBlC&originHeight=172&originWidth=1714&originalType=binary&ratio=1&rotation=0&showTitle=false&size=29145&status=error&style=stroke&taskId=u8300e576-e09f-4bde-9a82-257eeb5a940&title=&width=857)
...
![image-20220328194922739.png](https://cdn.nlark.com/yuque/0/2022/png/2345482/1654136219970-aba6955f-afb0-40ee-a733-0deb1e640df7.png#averageHue=%23ebebeb&clientId=u2bd2b050-3109-4&errorMessage=unknown%20error&from=paste&height=270&id=T2SPQ&originHeight=540&originWidth=1750&originalType=binary&ratio=1&rotation=0&showTitle=false&size=42182&status=error&style=stroke&taskId=u655ad959-3b3a-4164-8304-a87a6f341cc&title=&width=875)
