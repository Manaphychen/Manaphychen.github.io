...
1. 从官网下载 `mysql-8.0.34-macos13-arm64.tar.gz`版本，过程略...
...
5. 初始化配置文件，在mysql目录创建`my.cnf`并填写以下内容
```properties
[mysql]
# 设置mysql客户端默认字符集
default-character-set=utf8mb4
...
## MySQL实现rownum方式
```sql
SELECT @rownum:=@rownum+1 AS rownum, employees.*
...
![](https://cdn.nlark.com/yuque/0/2021/png/2345482/1616122338498-9c29c2d2-c2d8-44e1-a150-5d6de644da06.png#averageHue=%23f2f1f1&height=262&id=trTHd&originHeight=262&originWidth=536&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=stroke&title=&width=536)
...
![](https://cdn.nlark.com/yuque/0/2021/png/2345482/1616122338386-2d99282d-2df0-4f75-aa12-391c98b831c5.png#averageHue=%23f8f6f5&height=80&id=vpNfp&originHeight=80&originWidth=605&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=none&title=&width=605)
在服务器执行`docker inspect --format='{ {.NetworkSettings.IPAddress} }' 容器名称|容器id`获取主服务器容器的独立ip
![](https://cdn.nlark.com/yuque/0/2021/png/2345482/1616122338421-09e34340-03fd-4c67-949e-0ef5def9d696.png#averageHue=%230a0705&height=60&id=GbDcw&originHeight=60&originWidth=863&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=none&title=&width=863)
连接从服务器,执行以下命令
...
![](https://cdn.nlark.com/yuque/0/2021/png/2345482/1616122338416-6b64124f-b9c5-4da6-97d2-cf0891abf3b4.png#averageHue=%23f9f4f3&height=100&id=eqmki&originHeight=100&originWidth=1089&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=none&title=&width=1089)
红框里两个Yes代表搭建成功
