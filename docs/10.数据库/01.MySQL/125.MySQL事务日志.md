...
![image.png](https://cdn.nlark.com/yuque/0/2022/png/2345482/1652112122086-5285abc3-9d8f-4371-aced-7695b82f974f.png)
## 1.2 REDO日志的好处、特点
...
![image-20220328151424082.png](https://cdn.nlark.com/yuque/0/2022/png/2345482/1654137938866-99bad942-bd35-47b5-b7ce-7afd8450da74.png)
...
![image.png](https://www.pnglog.com/GMIWRO.png)
...
![image.png](https://www.pnglog.com/IAbDWk.png)
...
![image.png](https://www.pnglog.com/JhYOQY.png)
...
![image.png](https://www.pnglog.com/FTrOv1.png)
...
![image.png](https://www.pnglog.com/bSo28x.png)
...
![image.png](https://manaphy.oss-cn-hangzhou.aliyuncs.com/2024-03-08/a8bf4f50c7e34458abce899e920540f6png)
...
![image.png](https://www.pnglog.com/tLZlUK.png)
...
![image-20220328142935235.png](https://www.pnglog.com/ixacFQ.png)
...
![image.png](https://www.pnglog.com/CRcAYo.png)
...
![image.png](https://www.pnglog.com/ZsE1Gm.png)

如果 write pos 追上 checkpoint ，表示**日志文件组**满了，这时候不能再写入新的 redo log记录，MySQL 得停下来，清空一些记录，把 checkpoint 推进一下。

![image.png](https://www.pnglog.com/Fn2hYt.png)
## 1.9 redo log小结
相信大家都知道redo log的作用和它的刷盘时机、存储形式:

**InnoDB的更新操作采用的是Write Ahead Log(预先日志持久化)策略，即先写日志，再写入磁盘。**

![image-20220328141502562.png](https://cdn.nlark.com/yuque/0/2022/png/2345482/1654138461921-bea48e62-0d60-48d3-94fa-e471e630ed69.png)
# 2. Undo日志
...
![v2-ccc4f0ad502b8604d25ff00213853b54_1440w.jpg](https://www.pnglog.com/eXiHPB.jpeg)
## 2. 回滚段与事务
...
![image.png](https://cdn.nlark.com/yuque/0/2022/png/2345482/1652195425181-4111936c-0959-48c7-9708-6b4cc43230c8.png)

**有了Redo Log和Undo Log之后：**

![image.png](https://cdn.nlark.com/yuque/0/2022/png/2345482/1652195462480-37077dd1-83d8-455e-a0df-e135c56ea628.png)
...
![image.png](https://cdn.nlark.com/yuque/0/2022/png/2345482/1652195486646-5f5af596-f57b-474d-8ec6-ca6f0d7cf43e.png)
...
![image.png](https://www.pnglog.com/8lCWOv.png)
...
![image.png](https://cdn.nlark.com/yuque/0/2022/png/2345482/1652195584730-979065e6-581f-4a48-96bc-ca64035f1784.png)
...
![image.png](https://www.pnglog.com/AojlkF.png)
...
## 2.6 小结
![image.png](https://www.pnglog.com/8ImHjq.png)
