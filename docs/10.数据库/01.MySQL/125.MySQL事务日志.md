...
![image.png](https://www.pnglog.com/qkAzeD.png)
## 1.2 REDO日志的好处、特点
...
![image-20220328151424082.png](https://www.pnglog.com/ZuaUdt.png)
...
![image.png](https://www.pnglog.com/wQFpPh.png)
## 1.9 redo log小结
相信大家都知道redo log的作用和它的刷盘时机、存储形式:

**InnoDB的更新操作采用的是Write Ahead Log(预先日志持久化)策略，即先写日志，再写入磁盘。**

![image-20220328141502562.png](https://www.pnglog.com/bEgWUR.png)
# 2. Undo日志
...
![image.png](https://www.pnglog.com/D1INh3.png)

**有了Redo Log和Undo Log之后：**

![image.png](https://www.pnglog.com/e2sOaS.png)
...
![image.png](https://www.pnglog.com/yfOUF8.png)
...
![image.png](https://www.pnglog.com/Qc09ti.png)
