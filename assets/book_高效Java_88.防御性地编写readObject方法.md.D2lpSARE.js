import{_ as e,c as a,o as s,aj as n}from"./chunks/framework._AF764y6.js";const b=JSON.parse('{"title":"防御性地编写 readObject 方法","description":"","frontmatter":{"title":"防御性地编写 readObject 方法","date":"2023-10-25T01:05:38.000Z","categories":["技术书籍","高效Java","序列化"],"tags":["高效Java"],"author":"Manaphy"},"headers":[],"relativePath":"book/高效Java/88.防御性地编写readObject方法.md","filePath":"book/高效Java/88.防御性地编写readObject方法.md","lastUpdated":1743618064000}'),t={name:"book/高效Java/88.防御性地编写readObject方法.md"},i=n(`<h3 id="item-88-write-readobject-methods-defensively-防御性地编写-readobject-方法" tabindex="-1">Item 88: Write readObject methods defensively（防御性地编写 readObject 方法） <a class="header-anchor" href="#item-88-write-readobject-methods-defensively-防御性地编写-readobject-方法" aria-label="Permalink to “Item 88: Write readObject methods defensively（防御性地编写 readObject 方法）”">​</a></h3><p>Item 50 contains an immutable date-range class with mutable private Date fields. The class goes to great lengths to preserve its invariants and immutability by defensively copying Date objects in its constructor and accessors. Here is the class:</p><p><a href="./50-Make-defensive-copies-when-needed">Item-50</a> 包含一个具有可变私有 Date 字段的不可变日期范围类。该类通过在构造函数和访问器中防御性地复制 Date 对象，不遗余力地保持其不变性和不可变性。它是这样的：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark-dimmed vp-code" tabindex="0"><code><span class="line"><span>// Immutable class that uses defensive copying</span></span>
